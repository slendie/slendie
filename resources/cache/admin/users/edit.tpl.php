                    ...
                    <form action="<?php echo route( 'users.update', ['id' => $user->id] ); ?>" method="POST">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input class="form-control" type="text" name="name" id="name" value="<?php echo old('name', $user->name); ?>" required>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input class="form-control" type="email" name="email" id="email" value="<?php echo old('email', $user->email); ?>" required>

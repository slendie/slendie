        ...
        <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <form action="<?php echo route( 'cards.store' ); ?>" method="post">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label" for="title">Title</label>
                                <input class="form-control" type="text" name="title" id="title" value="<?php echo old('title'); ?>">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea class="form-control" id="resume" name="resume" rows="5" cols="80"><?php echo old('resume'); ?></textarea>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea class="form-control" id="content" name="content" rows="15" cols="80"><?php echo old('content'); ?></textarea>
